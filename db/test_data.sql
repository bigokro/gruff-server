...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'He was instrumental in ending Apartheid in South Africa' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Fidel Castro was instrumental in ending Apartheid in South Africa' WHERE d1.title = 'Fidel Castro deserves to be praised for his legacy';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'During his reign, Cuba was instrumental in the liberation of many African nations' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'During the reign of Fidel Castro, Cuba was instrumental in the liberation of many African nations' WHERE d1.title = 'Fidel Castro deserves to be praised for his legacy';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'Cuba was instrumental in liberating Angola and Mozambique' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Under instruction from Fidel Castro, Cuba played an important role in support of liberation struggles in Angola and Mozambique' WHERE d1.title = 'During the reign of Fidel Castro, Cuba was instrumental in the liberation of many African nations';
...
INSERT INTO "arguments" ("created_by_id", "target_argument_id","claim_id","type","relevance","impact","description","title") SELECT 1, a1.id, d2.id, 6, 1.0, 0.5, '', 'Cuba''s attempts at helping Ethiopia ended in disaster' FROM arguments a1 LEFT JOIN claims d2 ON d2.title = 'During the reign of Fidel Castro, Cuba''s attempts at helping Ethiopia ended in disaster' WHERE a1.title = 'During his reign, Cuba was instrumental in the liberation of many African nations';

-- Back to Root Pro-truth

INSERT INTO "claims" ("created_by_id","truth","description","title") VALUES ('1','0.5','','Fidel Castro was loved by the Cuban people');

INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'He was loved by the Cuban people' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Fidel Castro was loved by the Cuban people' WHERE d1.title = 'Fidel Castro deserves to be praised for his legacy';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'He created a more egalitarian society in Cuba' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Fidel Castro created a more egalitarian society in Cuba' WHERE d1.title = 'Fidel Castro deserves to be praised for his legacy';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'His regime replaced the Batista regime, a dictator that served his own interests and those of the wealthy' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'The Batista regime in Cuba served only Batist''s own interests and those of the wealthy' WHERE d1.title = 'Fidel Castro created a more egalitarian society in Cuba';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'According to The Guardian, the population of Cuba is content' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'The Guardian reports that the population is generally content with the egalitarian nature of Cuba' WHERE d1.title = 'In spite of hardships, the population is content due to the egalitarian nature of society in Cuba';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 2, 1.0, 0.5, '', 'Even in Cuba, the government plays with favoritism' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Even in Fidel Castro''s Cuba, not all people are treated equally' WHERE d1.title = 'Fidel Castro created a more egalitarian society in Cuba';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'He had the ability to face - together with his people - the most powerful enemy on earth.' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Fidel Castro had the ability to face - together with his people - the most powerful enemy on earth.' WHERE d1.title = 'Fidel Castro serves as inspiration to all nations that feel a need to stand up to bullying nations like the United States';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'He sent Cuban doctors to third world countries to help improve health conditions' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Fidel Castro sent Cuban doctors to third world countries to help improve health conditions' WHERE d1.title = 'Fidel Castro deserves to be praised for his legacy';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 1, 1.0, 0.5, '', 'He did, according to at least on Fox News article' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'A Fox News article mentions that Fidel Castro sent Cuban doctors to other countries to help with their health system' WHERE d1.title = 'Fidel Castro sent Cuban doctors to third world countries to help improve health conditions';
...
INSERT INTO "arguments" ("created_by_id", "target_claim_id","claim_id","type","relevance","impact","description","title") SELECT 1, d1.id, d2.id, 2, 1.0, 0.5, '', 'He executed thousands of people for being political dissidents' FROM claims d1 LEFT JOIN claims d2 ON d2.title = 'Fidel Castro executed thousands of people for being political dissidents' WHERE d1.title = 'Fidel Castro deserves to be praised for his legacy';
